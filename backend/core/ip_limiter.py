"""ip_limiter.py — Placeholder. Full implementation in subvox-confidential."""

import logging
logger = logging.getLogger(__name__)

logger.debug("Using public ip_limiter stub — business features from subvox-confidential are inactive")
