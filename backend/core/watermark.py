"""watermark.py — Placeholder. Full implementation in subvox-confidential."""

import logging
logger = logging.getLogger(__name__)

logger.debug("Using public watermark stub — business features from subvox-confidential are inactive")
