...
STEP_COLUMNS: dict[str, tuple[str, str]] = {
    "downloading": ("step_data", "Téléchargement vidéo"),
    "meta_analysis": ("step_data", "Analyse métadonnées"),
    "transcribing": ("step_data", "Transcription audio"),
    "filtering": ("step_data", "Filtre hallucinations"),
    "text_analysis": ("step_data", "Analyse textuelle"),
    "visual_analysis": ("step_data", "Analyse visuelle"),
    "anonymization": ("step_data", "Anonymisation vidéo"),
    "speaker_analysis": ("step_data", "Analyse locuteurs"),
    "fusion": ("step_data", "Fusion analyses"),
    "seo": ("seo_metadata", "SEO Metadata"),
    "summary": ("summaries", "Résumé LLM"),
    "translating": ("step_data", "Traduction SRT"),
    "segments_save": ("step_data", "Sauvegarde segments"),
    "ass_generation": ("step_data", "Génération ASS"),
    "vtt_export": ("step_data", "Export VTT"),
    "watermark": ("step_data", "Watermark"),
    "burning": ("step_data", "Burn sous-titres"),
    "uploading": ("step_data", "Upload final"),
}
