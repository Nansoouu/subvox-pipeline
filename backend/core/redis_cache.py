"""redis_cache.py — Placeholder. Full implementation in subvox-confidential."""

import logging
logger = logging.getLogger(__name__)

logger.debug("Using public redis_cache stub — business features from subvox-confidential are inactive")
