...
<p align="center">
  <strong>Le moteur open-source de traduction vidéo.</strong><br/>
  Télécharger. Transcrire. Traduire. Incruster. Une pipeline, toutes les langues.
</p>
...
>
> Subvox, c'est aussi l'idée de contribuer communautairement pour rendre accessible à tous la traduction de contenu vidéo. Contrairement à **Veed.io**, **Kapwing**, **Descript** ou **Opus Clip**, des mastodontes qui facturent très cher ce qui devrait être gratuit et qui limitent beaucoup. Subvox est ouvert, transparent, et construit par ceux qui l'utilisent.
>
...
>
> Ce pipeline est le cœur technique. Le reste, wallets, tokens, économie, vit ailleurs. Ici, c'est la machine à traduire le monde. Libre. Ouvert. À toi.
>
> *Nansou*
...
**Bonus :** Export VTT/SRT, watermark auto, détection de scènes, analyse de contenu.
...
5. Incrustation
   ...
   │  Watermark auto, style personnalisable
   ▼
6. Résultat
   │  Vidéo sous-titrée, prête à partager
   │  Export SRT/VTT disponible
```
...
- **Issues** : signale un bug, propose une feature
- **PRs** : code, docs, tests, tout est bon à prendre
- **Discussions** : partage ton cas d'usage

Le pipeline est **100% open-source** (MIT). La couche économique (wallets, tokens) reste privée pour des raisons de sécurité.
